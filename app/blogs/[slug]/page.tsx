    ...
    <div className={`${poppins.variable} min-h-screen bg-white`}>
      ...
      <div className="bg-brand relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 py-20">
          <Link href="/blogs" className="text-white/70 hover:text-white text-sm mb-4 inline-block transition-colors">
            <ArrowLeft size={14} className="inline mr-1" /> Back to Blogs
          </Link>
          <h1
