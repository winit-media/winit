  ...
  return (
    <div className="min-h-svh bg-gray-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-lg p-8 w-full max-w-md text-center">
        <h1 className="text-xl font-bold text-gray-900 mb-2">Failed to load post</h1>
        <p className="text-gray-500 text-sm mb-6">
          The blog post could not be loaded. It may have been removed or the link may be incorrect.
        </p>
        <button
          onClick={reset}
